...
TEST_FILE_PATH = str(Path.home() / "Desktop" / "manual_test.txt")
MODEL_PATH = "models/guard_model.joblib"
OUTPUT_CSV_PATH = ""
...
def load_texts(path: str) -> tuple[list[str], pd.DataFrame]:
...
def main() -> None:
    ...
    parser.add_argument("--out", default=OUTPUT_CSV_PATH)
    args = parser.parse_args()

    bundle = load_bundle(args.model)
    texts, df = load_texts(args.file)

    result = predict_texts(bundle, texts, args.threshold)
